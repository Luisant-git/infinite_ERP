...
export class AuthService {
  ...
  async register(registerDto: any) {
    ...
    const userData: any = {
      ...
      concernIds: concernIds ? (typeof concernIds === 'string' ? concernIds : JSON.stringify(concernIds)) : '[]',
      canAdd: canAdd || false,
  ...
  async updateUser(id: number, updateData: any) {
    ...
    const updateFields: any = {
      ...
      dcClose,
      isActive,
      concernIds: concernIds !== undefined ? (typeof concernIds === 'string' ? concernIds : JSON.stringify(concernIds)) : undefined,
      canAdd,
      canEdit,
      canDelete,
      IsMD
