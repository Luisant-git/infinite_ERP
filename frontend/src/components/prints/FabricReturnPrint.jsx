        ...
        <table className="details-table" style={{ borderTop: 'none' }}>
          <tbody>
            <tr className="total-row">
              <td colSpan={2} style={{ width: '45%', border: 'none', borderLeft: '1px solid #000', textAlign: 'left', paddingLeft: '4px', fontWeight: 'normal', fontSize: '10px' }}>Remarks : {data.remarks || ''}</td>
