...
const FabricDc = () => {
  ...
  const handleEdit = (record) => {
    ...
    setDcType(record.dcType || 'Production');
    setIsFormVisible(true);
  };
            ...
            <Col span={8}>
              <Form.Item label="DC Type" name="dcType" style={{ marginBottom: 6 }}>
                <Radio.Group disabled size="small">
                  ...
                  <Radio value="Re-Process(Free)">Re-Process(Free)</Radio>
                  <Radio value="Re-Process(Charge)">Re-Process(Charge)</Radio>
