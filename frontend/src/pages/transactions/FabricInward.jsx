        ...
        <Space size="small">
          ...
          {canEdit('fabric_inward') && (
            <Button 
              ...
              title={record.isLocked ? 'Cannot edit - used in DC/Return/Bill' : 'Edit'}
            />
          )}
          {canDelete('fabric_inward') && (
            <Button 
              ...
              disabled={record.isLocked}
              title={record.isLocked ? 'Cannot delete - used in DC/Return/Bill' : 'Delete'}
            />
          )}
  ...
  return (
    <Card>
      ...
      <div className="page-header" style={{ marginBottom: 12, display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
        <Title level={4} style={{ margin: 0, whiteSpace: 'nowrap' }}>Fabric Inward</Title>
        {!isFormVisible && (
